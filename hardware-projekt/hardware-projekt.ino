...
// WE NEED TO IMPLEMENT A WIN SCREEN, WE ONLY HAVE A GAME OVER SCREEN, THE GAME KEEPS RUNNING EVEN AFTER ALL PELLETS ARE COLLECTED
//SMOOTHE OUT JOYSTICK MOVEMENT?
